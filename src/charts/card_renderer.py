...
def _gen_html(a):
    ...
    return "<!DOCTYPE html>\n<html lang=\"zh-CN\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=2160\"><style>\n*{margin:0;padding:0;box-sizing:border-box}\nbody{background:#060709;color:#e0e0e0;font-family:\"Microsoft YaHei\",sans-serif;width:1200px;margin:0 auto;padding:24px}\n.card{background:#0b0d13;border-radius:6px;padding:20px 20px;border:1px solid #1a1d28;margin-bottom:18px}\n.card-title{font-size:16px;font-weight:700;color:#8a8f9d;letter-spacing:0.5px;margin-bottom:10px;display:flex;align-items:center;gap:6px}\n.card-title::before{content:\"\";width:3px;height:13px;background:#F15A24}\n.col2{display:grid;grid-template-columns:1fr 1fr;gap:18px}\n.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:12px}\n.p-name{font-size:28px;font-weight:bold;color:#fff}\n.p-sub{font-size:16px;color:#777;margin-top:3px}\n.rank-badge{background:#1a2744;border:1px solid #2d5aa0;color:#fff;padding:6px 16px;border-radius:5px;text-align:right}\n.rank-badge.master{background:#1a1a2e;border:1px solid #8b5cf6}\n.r-tier{font-size:18px;font-weight:bold;color:#fff}\n.r-score{font-size:24px;font-weight:bold;color:#a78bfa;margin-top:2px}\n.tag{display:inline-block;background:rgba(61,26,69,0.5);color:#c084fc;padding:4px 12px;border-radius:12px;font-size:16px;margin:4px;border:1px solid rgba(155,89,182,0.3)}\n.streak-panel{display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-bottom:10px}\n.streak-cell{background:#0b0d13;border:1px solid #1a1d28;border-radius:5px;padding:16px 20px}\n.streak-label{font-size:15px;color:#666;margin-bottom:5px}\n.streak-stats{display:flex;gap:20px;font-size:16px;align-items:center}\n.s-w{color:#2ecc71}\n.s-l{color:#e74c3c}\n.streak-good{color:#2ecc71;font-weight:bold}\n.streak-bad{color:#e74c3c;font-weight:bold;background:rgba(231,76,60,0.1);padding:2px 8px;border-radius:3px}\n.gauge-bar{display:flex;height:12px;border-radius:4px;overflow:hidden;margin-bottom:12px}\n.sa-seg{height:100%}\n.sa-rows{display:grid;grid-template-columns:1fr 1fr;gap:6px 20px;font-size:16px}\n.sa-row,.dr-row{display:flex;align-items:center;gap:6px;color:#aaa}\n.sa-circ,.dr-circ{width:8px;height:8px;border-radius:50%;flex-shrink:0}\n.stat-row{display:flex;align-items:center;gap:10px;font-size:14px;padding:4px 0;border-bottom:1px solid #11141d}\n.stat-label{width:100px;color:#aaa;flex-shrink:0}\n.stat-val{width:60px;font-weight:600;color:#fff;text-align:right}\n.stat-ref{width:110px;color:#666;font-size:13px;text-align:right}\n.stat-tag{width:70px;font-size:13px;text-align:right;font-weight:600}\n.vs-row{display:flex;align-items:center;gap:10px;font-size:14px;padding:5px 0;border-bottom:1px solid #11141d}\n.vs-name{width:75px;color:#fff;font-weight:bold}\n.vs-bar-track{flex:1;height:8px;background:#1a1d28;border-radius:2px;overflow:hidden}\n.vs-bar-fill{height:100%;background:#F15A24;border-radius:2px}\n.vs-rate{width:50px;color:#fff;font-weight:600;text-align:right}\n.vs-detail{width:42px;color:#666;font-size:13px;text-align:right}\n.low-sample{font-size:14px;color:#555;margin-top:8px}\n</style></head><body>\n<div class=\"header\">\n  <div>\n    <div class=\"p-name\">" + a["username"] + "</div>\n    <div class=\"p-sub\">CFN " + str(a["player_id"]) + " | Main: " + a["main_char"] + "</div>\n    <div class=\"p-sub\">" + a["platform"] + " | \u6392\u4f4d\u573a\u6b21: " + str(a.get("games", 0)) + "</div>\n  </div>\n  " + title_html + "\n</div>\n<div class=\"streak-panel\">" + streak_html + "</div>\n<div style=\"margin-bottom:10px\">" + tags_html + "</div>\n<div class=\"col2\">\n  <div class=\"card\">\n    <div class=\"card-title\">SA \u69fd\u5206\u5e03</div>\n    <div class=\"gauge-bar\">" + sa_bar + "</div>\n    <div class=\"sa-rows\">" + sa_rows + "</div>\n  </div>\n  <div class=\"card\">\n    <div class=\"card-title\">DRIVE GAUGE USAGE</div>\n    <div class=\"gauge-bar\">" + dr_bar + "</div>\n    <div class=\"sa-rows\">" + dr_rows + "</div>\n  </div>\n  <div class=\"card\">\n    <div class=\"card-title\">OFFENSE</div>\n    " + off_rows + "\n  </div>\n  <div class=\"card\">\n    <div class=\"card-title\">DEFENSE</div>\n    " + def_rows + "\n  </div>\n</div>\n<div class=\"card\">\n  <div class=\"card-title\">VS MATCHUPS</div>\n  " + vs_rows + "\n  " + low_html + "\n</div>\n</body></html>"
