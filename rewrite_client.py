...
def _parse_response(raw, sf6_id):
    ...
    if not isinstance(raw, dict):
        return None
    props = raw.get("props", {}).get("pageProps", {}) or raw
    fighter = props.get("fighter") or props.get("fighterData") or props.get("data") or props
    ...
    data.game_time = GameModeTime(
        total_play_time=play.get("totalPlayTime") or play.get("total_play_time") or 0,
        ranked_time=play.get("rankedMatchPlayTime") or play.get("ranked_match_play_time") or 0,
        casual_time=play.get("casualMatchPlayTime") or play.get("casual_match_play_time") or 0,
        battle_hub_time=play.get("battleHubPlayTime") or play.get("battle_hub_play_time") or 0,
        training_time=play.get("trainingModePlayTime") or play.get("training_mode_play_time") or 0,
        arcade_time=play.get("arcadeModePlayTime") or play.get("arcade_mode_play_time") or 0,
        custom_room_time=play.get("customRoomPlayTime") or play.get("custom_room_play_time") or 0,
        world_tour_time=play.get("worldTourPlayTime") or play.get("world_tour_play_time") or 0,
        extreme_battle_time=play.get("extremeBattlePlayTime") or play.get("extreme_battle_play_time") or 0,
    )
    tech_raw = fighter.get("technicalStats") or fighter.get("technical_stats") or {}
    data.tech_stats = TechStats(
        games_played=tech_raw.get("gamesPlayed") or tech_raw.get("games_played") or 0,
        corner_pressure_time=tech_raw.get("cornerPressureTime") or tech_raw.get("corner_pressure_time") or 0,
        corner_pressured_time=tech_raw.get("cornerPressuredTime") or tech_raw.get("corner_pressured_time") or 0,
        throws_landed=tech_raw.get("throwsLanded") or tech_raw.get("throws_landed") or 0,
        throw_escapes=tech_raw.get("throwEscapes") or tech_raw.get("throw_escapes") or 0,
        perfect_parries=tech_raw.get("perfectParries") or tech_raw.get("perfect_parries") or 0,
        drive_impacts=tech_raw.get("driveImpacts") or tech_raw.get("drive_impacts") or 0,
        drive_impact_counters=tech_raw.get("driveImpactCounters") or tech_raw.get("drive_impact_counters") or 0,
        drive_impacts_received=tech_raw.get("driveImpactsReceived") or tech_raw.get("drive_impacts_received") or 0,
        punish_counters=tech_raw.get("punishCounters") or tech_raw.get("punish_counters") or 0,
        punished_received=tech_raw.get("punishedReceived") or tech_raw.get("punished_received") or 0,
        super_arts=tech_raw.get("superArts") or tech_raw.get("super_arts") or 0,
        combos_max_damage=tech_raw.get("combosMaxDamage") or tech_raw.get("combos_max_damage") or 0,
        combos_avg_damage=tech_raw.get("combosAvgDamage") or tech_raw.get("combos_avg_damage") or 0,
    )
    dr_raw = tech_raw.get("driveUsage") or tech_raw.get("drive_usage") or {}
    data.drive_usage = DriveUsage(
        drive_rush_cancel=dr_raw.get("driveRushCancel") or dr_raw.get("drive_rush_cancel") or 0,
        overdrive=dr_raw.get("overdrive") or 0,
        drive_reversal=dr_raw.get("driveReversal") or dr_raw.get("drive_reversal") or 0,
        raw_drive_rush=dr_raw.get("rawDriveRush") or dr_raw.get("raw_drive_rush") or 0,
        drive_parry=dr_raw.get("driveParry") or dr_raw.get("drive_parry") or 0,
        burnout_drain=dr_raw.get("burnoutDrain") or dr_raw.get("burnout_drain") or 0,
    )
    ...
    for m in ranked: data.ranked_matchups.append(MatchupStat(opponent_char=m.get("characterName","") or m.get("character_name","") or "Unknown", wins=m.get("wins",0) or m.get("win",0) or 0, total=m.get("totalGames",0) or m.get("total_games",0) or 0, mode="ranked"))
    for m in casual: data.casual_matchups.append(MatchupStat(opponent_char=m.get("characterName","") or m.get("character_name","") or "Unknown", wins=m.get("wins",0) or m.get("win",0) or 0, total=m.get("totalGames",0) or m.get("total_games",0) or 0, mode="casual"))
    for m in bh: data.battle_hub_matchups.append(MatchupStat(opponent_char=m.get("characterName","") or m.get("character_name","") or "Unknown", wins=m.get("wins",0) or m.get("win",0) or 0, total=m.get("totalGames",0) or m.get("total_games",0) or 0, mode="battle_hub"))
